...
{
    public static readonly Guid BaghdadId = new("0001-0001-0000-0000-000000000000");
    public static readonly Guid BasraId = new("0001-0002-0000-0000-000000000000");
    public static readonly Guid MosulId = new("0001-0003-0000-0000-000000000000");
    public static readonly Guid ErbilId = new("0001-0004-0000-0000-000000000000");
    public static readonly Guid KirkukId = new("0001-0005-0000-0000-000000000000");
    public static readonly Guid NajafId = new("0001-0006-0000-0000-000000000000");
    public static readonly Guid KarbalaId = new("0001-0007-0000-0000-000000000000");
    public static readonly Guid SulaymaniyahId = new("0001-0008-0000-0000-000000000000");
    public static readonly Guid DohukId = new("0001-0009-0000-0000-000000000000");
    public static readonly Guid DiyalaId = new("0001-0010-0000-0000-000000000000");
    public static readonly Guid BabilId = new("0001-0011-0000-0000-000000000000");
    public static readonly Guid AnbarId = new("0001-0012-0000-0000-000000000000");
    public static readonly Guid WasitId = new("0001-0013-0000-0000-000000000000");
    public static readonly Guid DhiQarId = new("0001-0014-0000-0000-000000000000");
    public static readonly Guid MaysanId = new("0001-0015-0000-0000-000000000000");
    public static readonly Guid QadisiyahId = new("0001-0016-0000-0000-000000000000");
    public static readonly Guid SalahAlDinId = new("0001-0017-0000-0000-000000000000");
    public static readonly Guid NinevehId = new("0001-0018-0000-0000-000000000000");

    public static readonly Guid AlabamaId = new("0002-0001-0000-0000-000000000000");
    public static readonly Guid AlaskaId = new("0002-0002-0000-0000-000000000000");
    public static readonly Guid ArizonaId = new("0002-0003-0000-0000-000000000000");
    public static readonly Guid ArkansasId = new("0002-0004-0000-0000-000000000000");
    public static readonly Guid CaliforniaId = new("0002-0005-0000-0000-000000000000");
    public static readonly Guid ColoradoId = new("0002-0006-0000-0000-000000000000");
    public static readonly Guid ConnecticutId = new("0002-0007-0000-0000-000000000000");
    public static readonly Guid DelawareId = new("0002-0008-0000-0000-000000000000");
    public static readonly Guid FloridaId = new("0002-0009-0000-0000-000000000000");
    public static readonly Guid GeorgiaId = new("0002-0010-0000-0000-000000000000");
    public static readonly Guid HawaiiId = new("0002-0011-0000-0000-000000000000");
    public static readonly Guid IdahoId = new("0002-0012-0000-0000-000000000000");
    public static readonly Guid IllinoisId = new("0002-0013-0000-0000-000000000000");
    public static readonly Guid IndianaId = new("0002-0014-0000-0000-000000000000");
    public static readonly Guid IowaId = new("0002-0015-0000-0000-000000000000");
    public static readonly Guid KansasId = new("0002-0016-0000-0000-000000000000");
    public static readonly Guid KentuckyId = new("0002-0017-0000-0000-000000000000");
    public static readonly Guid LouisianaId = new("0002-0018-0000-0000-000000000000");
    public static readonly Guid MaineId = new("0002-0019-0000-0000-000000000000");
    public static readonly Guid MarylandId = new("0002-0020-0000-0000-000000000000");
    public static readonly Guid MassachusettsId = new("0002-0021-0000-0000-000000000000");
    public static readonly Guid MichiganId = new("0002-0022-0000-0000-000000000000");
    public static readonly Guid MinnesotaId = new("0002-0023-0000-0000-000000000000");
    public static readonly Guid MississippiId = new("0002-0024-0000-0000-000000000000");
    public static readonly Guid MissouriId = new("0002-0025-0000-0000-000000000000");
    public static readonly Guid MontanaId = new("0002-0026-0000-0000-000000000000");
    public static readonly Guid NebraskaId = new("0002-0027-0000-0000-000000000000");
    public static readonly Guid NevadaId = new("0002-0028-0000-0000-000000000000");
    public static readonly Guid NewHampshireId = new("0002-0029-0000-0000-000000000000");
    public static readonly Guid NewJerseyId = new("0002-0030-0000-0000-000000000000");
    public static readonly Guid NewMexicoId = new("0002-0031-0000-0000-000000000000");
    public static readonly Guid NewYorkId = new("0002-0032-0000-0000-000000000000");
    public static readonly Guid NorthCarolinaId = new("0002-0033-0000-0000-000000000000");
    public static readonly Guid NorthDakotaId = new("0002-0034-0000-0000-000000000000");
    public static readonly Guid OhioId = new("0002-0035-0000-0000-000000000000");
    public static readonly Guid OklahomaId = new("0002-0036-0000-0000-000000000000");
    public static readonly Guid OregonId = new("0002-0037-0000-0000-000000000000");
    public static readonly Guid PennsylvaniaId = new("0002-0038-0000-0000-000000000000");
    public static readonly Guid RhodeIslandId = new("0002-0039-0000-0000-000000000000");
    public static readonly Guid SouthCarolinaId = new("0002-0040-0000-0000-000000000000");
    public static readonly Guid SouthDakotaId = new("0002-0041-0000-0000-000000000000");
    public static readonly Guid TennesseeId = new("0002-0042-0000-0000-0000-000000000000");
    public static readonly Guid TexasId = new("0002-0043-0000-0000-0000-000000000000");
    public static readonly Guid UtahId = new("0002-0044-0000-0000-0000-000000000000");
    public static readonly Guid VermontId = new("0002-0045-0000-0000-0000-000000000000");
    public static readonly Guid VirginiaId = new("0002-0046-0000-0000-0000-000000000000");
    public static readonly Guid WashingtonId = new("0002-0047-0000-0000-0000-000000000000");
    public static readonly Guid WestVirginiaId = new("0002-0048-0000-0000-0000-000000000000");
    public static readonly Guid WisconsinId = new("0002-0049-0000-0000-0000-000000000000");
    public static readonly Guid WyomingId = new("0002-0050-0000-0000-0000-000000000000");

...
public class AreaSeed : IEntitySeed<Area>
{
    ...
    {
        public static readonly Guid KarkhId           = new("0001-0001-0001-0000-0000-000000000000");
        public static readonly Guid RusafaId          = new("0001-0001-0002-0000-0000-000000000000");
        public static readonly Guid KarradaId         = new("0001-0001-0003-0000-0000-000000000000");
        public static readonly Guid AdhamiyahId       = new("0001-0001-0004-0000-0000-000000000000");
        public static readonly Guid MansourId         = new("0001-0001-0005-0000-0000-000000000000");
        public static readonly Guid SadrCityId        = new("0001-0001-0006-0000-0000-000000000000");
        public static readonly Guid DoraId            = new("0001-0001-0007-0000-0000-000000000000");
        public static readonly Guid GhazaliyaId       = new("0001-0001-0008-0000-0000-000000000000");
        public static readonly Guid AmiriyaId         = new("0001-0001-0009-0000-0000-000000000000");
        public static readonly Guid ZayounaId         = new("0001-0001-0010-0000-0000-000000000000");
        public static readonly Guid PalestineStreetId = new("0001-0001-0011-0000-0000-000000000000");
        public static readonly Guid HurriyaId         = new("0001-0001-0012-0000-0000-000000000000");
        public static readonly Guid BayaaId           = new("0001-0001-0013-0000-0000-000000000000");
        public static readonly Guid ShaabId           = new("0001-0001-0014-0000-0000-000000000000");
        public static readonly Guid JadiriyahId       = new("0001-0001-0015-0000-0000-000000000000");
        public static readonly Guid ShurjaId          = new("0001-0001-0016-0000-0000-000000000000");
        public static readonly Guid FadhilId          = new("0001-0001-0017-0000-0000-000000000000");
        public static readonly Guid SheikhOmarId      = new("0001-0001-0018-0000-0000-000000000000");
        public static readonly Guid JesrDiyalaId      = new("0001-0001-0019-0000-0000-000000000000");
        public static readonly Guid AbuDisherId       = new("0001-0001-0020-0000-0000-000000000000");
        public static readonly Guid YarmoukId         = new("0001-0001-0021-0000-0000-000000000000");
        public static readonly Guid AlHebnaaId        = new("0001-0001-0022-0000-0000-000000000000");
        public static readonly Guid AlMahmudiyahId    = new("0001-0001-0023-0000-0000-000000000000");
        public static readonly Guid BabAlMoathamId    = new("0001-0001-0024-0000-0000-000000000000");
        public static readonly Guid BabAlSharqiId     = new("0001-0001-0025-0000-0000-000000000000");
        public static readonly Guid AlFathelId        = new("0001-0001-0026-0000-0000-000000000000");
        public static readonly Guid AlUbedyId         = new("0001-0001-0027-0000-0000-000000000000");
        public static readonly Guid AlWashashId       = new("0001-0001-0028-0000-0000-000000000000");
        public static readonly Guid AlWazireyaId      = new("0001-0001-0029-0000-0000-000000000000");
        public static readonly Guid HayyUrId          = new("0001-0001-0030-0000-0000-000000000000");
        public static readonly Guid HayyAlJamiyaId    = new("0001-0001-0031-0000-0000-000000000000");
        public static readonly Guid AlAdelId          = new("0001-0001-0032-0000-0000-000000000000");
        public static readonly Guid AlKhadhraaId      = new("0001-0001-0033-0000-0000-000000000000");
        public static readonly Guid HayyAlJihadId     = new("0001-0001-0034-0000-0000-000000000000");
        public static readonly Guid HayyAlAamelId     = new("0001-0001-0035-0000-0000-000000000000");
        public static readonly Guid HayyAoorId        = new("0001-0001-0036-0000-0000-000000000000");
        public static readonly Guid HayyAlShurttaId   = new("0001-0001-0037-0000-0000-000000000000");
        public static readonly Guid IskanId           = new("0001-0001-0038-0000-0000-000000000000");
        public static readonly Guid AlGazaliyahId     = new("0001-0001-0039-0000-0000-000000000000");
        public static readonly Guid AlSalamId         = new("0001-0001-0040-0000-0000-000000000000");
        public static readonly Guid AlIntisarId       = new("0001-0001-0041-0000-0000-000000000000");
        public static readonly Guid AlBaladiyat2Id    = new("0001-0001-0042-0000-0000-000000000000");
        public static readonly Guid AlDawoodiId       = new("0001-0001-0043-0000-0000-000000000000");
        public static readonly Guid AlDhuhbaatId      = new("0001-0001-0044-0000-0000-000000000000");
        public static readonly Guid AlElwiyaId        = new("0001-0001-0045-0000-0000-000000000000");
        public static readonly Guid AlKhansaaId       = new("0001-0001-0046-0000-0000-000000000000");
        public static readonly Guid AlLatifiyaId      = new("0001-0001-0047-0000-0000-000000000000");
        public static readonly Guid HaifaStreetId     = new("0001-0001-0048-0000-0000-000000000000");
        public static readonly Guid AlMaidanId        = new("0001-0001-0049-0000-0000-000000000000");
        public static readonly Guid SinaaId           = new("0001-0001-0050-0000-0000-000000000000");
        public static readonly Guid AlKaramaId        = new("0001-0001-0051-0000-0000-000000000000");
        public static readonly Guid AlWaziriyaId      = new("0001-0001-0052-0000-0000-000000000000");
        public static readonly Guid AlMustansiriyaId  = new("0001-0001-0053-0000-0000-000000000000");
        public static readonly Guid AlKhaleejId       = new("0001-0001-0054-0000-0000-000000000000");
        public static readonly Guid AlKhilaniId       = new("0001-0001-0055-0000-0000-000000000000");
        public static readonly Guid AlAmilId          = new("0001-0001-0056-0000-0000-000000000000");
        public static readonly Guid AlHurriyaId       = new("0001-0001-0057-0000-0000-000000000000");
        public static readonly Guid AlHarthiyaId      = new("0001-0001-0058-0000-0000-000000000000");
        public static readonly Guid AlQahiraId        = new("0001-0001-0059-0000-0000-000000000000");
        public static readonly Guid AlRasheedId       = new("0001-0001-0060-0000-0000-000000000000");
        public static readonly Guid AlNidalId         = new("0001-0001-0061-0000-0000-000000000000");
        public static readonly Guid AlShorjaId        = new("0001-0001-0062-0000-0000-000000000000");
        public static readonly Guid AlMansour2Id      = new("0001-0001-0063-0000-0000-000000000000");
        public static readonly Guid AlShaab2Id        = new("0001-0001-0064-0000-0000-000000000000");
        public static readonly Guid AlHurriya2Id      = new("0001-0001-0065-0000-0000-000000000000");
        public static readonly Guid AlShurta2Id       = new("0001-0001-0066-0000-0000-000000000000");
        public static readonly Guid AlBaladiyat3Id    = new("0001-0001-0067-0000-0000-000000000000");
        public static readonly Guid AlMansour3Id      = new("0001-0001-0068-0000-0000-000000000000");
        public static readonly Guid AlAdel2Id         = new("0001-0001-0069-0000-0000-000000000000");
        public static readonly Guid AlKadhraa2Id      = new("0001-0001-0070-0000-0000-000000000000");
        public static readonly Guid AlZaafaranId      = new("0001-0001-0071-0000-0000-000000000000");
        public static readonly Guid AlKhalisId        = new("0001-0001-0072-0000-0000-000000000000");
        public static readonly Guid AlRasheed2Id      = new("0001-0001-0073-0000-0000-000000000000");
        public static readonly Guid AlJadriyaId       = new("0001-0001-0074-0000-0000-000000000000");
        public static readonly Guid AlMaamilId        = new("0001-0001-0075-0000-0000-000000000000");
        public static readonly Guid AlHurriyah3Id     = new("0001-0001-0076-0000-0000-000000000000");
        public static readonly Guid AlRashid3Id       = new("0001-0001-0077-0000-0000-000000000000");
        public static readonly Guid AlMansour4Id      = new("0001-0001-0078-0000-0000-000000000000");
        public static readonly Guid AlShaab3Id        = new("0001-0001-0079-0000-0000-000000000000");
        public static readonly Guid AlKadisiyaId      = new("0001-0001-0080-0000-0000-000000000000");
        public static readonly Guid AlAmeenId         = new("0001-0001-0081-0000-0000-000000000000");
        public static readonly Guid AlSalam2Id        = new("0001-0001-0082-0000-0000-000000000000");
        public static readonly Guid AlWaziriyah2Id    = new("0001-0001-0083-0000-0000-000000000000");
        public static readonly Guid AlRashidiyahId    = new("0001-0001-0084-0000-0000-000000000000");
        public static readonly Guid AlMutanabbiId     = new("0001-0001-0085-0000-0000-000000000000");
        public static readonly Guid AlShurta3Id       = new("0001-0001-0086-0000-0000-000000000000");
        public static readonly Guid AlAdel3Id         = new("0001-0001-0087-0000-0000-000000000000");
        public static readonly Guid AlKhadhraa3Id     = new("0001-0001-0088-0000-0000-000000000000");
        public static readonly Guid AlQahira2Id       = new("0001-0001-0089-0000-0000-000000000000");
        public static readonly Guid AlHurriya4Id      = new("0001-0001-0090-0000-0000-000000000000");
        public static readonly Guid AlKarama2Id       = new("0001-0001-0091-0000-0000-000000000000");
        public static readonly Guid AlMaidan2Id       = new("0001-0001-0092-0000-0000-000000000000");
        public static readonly Guid AlShaab4Id        = new("0001-0001-0093-0000-0000-000000000000");
        public static readonly Guid AlBaladiyat4Id    = new("0001-0001-0094-0000-0000-000000000000");
        public static readonly Guid AlJadriya2Id      = new("0001-0001-0095-0000-0000-000000000000");
        public static readonly Guid AlAmiriya2Id      = new("0001-0001-0096-0000-0000-000000000000");
        public static readonly Guid AlDora2Id         = new("0001-0001-0097-0000-0000-000000000000");
        public static readonly Guid AlSadrCity2Id     = new("0001-0001-0098-0000-0000-000000000000");
        public static readonly Guid AlKarrada2Id      = new("0001-0001-0099-0000-0000-000000000000");
        public static readonly Guid AlRusafa2Id       = new("0001-0001-0100-0000-0000-000000000000");
        public static readonly Guid AlRashid4Id       = new("0001-0001-0101-0000-0000-000000000000");
        public static readonly Guid AlHurriya5Id      = new("0001-0001-0102-0000-0000-000000000000");
        public static readonly Guid AlShaab5Id        = new("0001-0001-0103-0000-0000-000000000000");
        public static readonly Guid AlMansour5Id      = new("0001-0001-0104-0000-0000-000000000000");
        public static readonly Guid AlKadisiya2Id     = new("0001-0001-0105-0000-0000-000000000000");
        public static readonly Guid AlAmeen2Id        = new("0001-0001-0106-0000-0000-000000000000");
        public static readonly Guid AlSalam3Id        = new("0001-0001-0107-0000-0000-000000000000");
        public static readonly Guid AlWaziriyah3Id    = new("0001-0001-0108-0000-0000-000000000000");
        public static readonly Guid AlRashidiyah2Id   = new("0001-0001-0109-0000-0000-000000000000");
        public static readonly Guid AlMutanabbi2Id    = new("0001-0001-0110-0000-0000-000000000000");
        public static readonly Guid AlShurta4Id       = new("0001-0001-0111-0000-0000-000000000000");
        public static readonly Guid AlAdel4Id         = new("0001-0001-0112-0000-0000-000000000000");
        public static readonly Guid AlKhadhraa4Id     = new("0001-0001-0113-0000-0000-000000000000");
        public static readonly Guid AlQahira3Id       = new("0001-0001-0114-0000-0000-000000000000");
        public static readonly Guid AlHurriya6Id      = new("0001-0001-0115-0000-0000-000000000000");
        public static readonly Guid AlKarama3Id       = new("0001-0001-0116-0000-0000-000000000000");
        public static readonly Guid AlMaidan3Id       = new("0001-0001-0117-0000-0000-000000000000");
        public static readonly Guid AlShaab6Id        = new("0001-0001-0118-0000-0000-000000000000");
        public static readonly Guid AlBaladiyat5Id    = new("0001-0001-0119-0000-0000-000000000000");
        public static readonly Guid AlJadriya3Id      = new("0001-0001-0120-0000-0000-000000000000");
    }

    public static class WashingtonAreaSeed
    {
        public static readonly Guid GeorgetownId             = new("0002-0001-0001-0000-0000-000000000000");
        public static readonly Guid CapitolHillId            = new("0002-0001-0002-0000-0000-000000000000");
        public static readonly Guid DupontCircleId           = new("0002-0001-0003-0000-0000-000000000000");
        public static readonly Guid AdamsMorganId            = new("0002-0001-0004-0000-0000-000000000000");
        public static readonly Guid ColumbiaHeightsId        = new("0002-0001-0005-0000-0000-000000000000");
        public static readonly Guid NavyYardId               = new("0002-0001-0006-0000-0000-000000000000");
        public static readonly Guid FoggyBottomId            = new("0002-0001-0007-0000-0000-000000000000");
        public static readonly Guid ShawId                   = new("0002-0001-0008-0000-0000-000000000000");
        public static readonly Guid BrooklandId              = new("0002-0001-0009-0000-0000-000000000000");
        public static readonly Guid TenleytownId             = new("0002-0001-0010-0000-0000-000000000000");
        public static readonly Guid AnacostiaId              = new("0002-0001-0011-0000-0000-000000000000");
        public static readonly Guid PetworthId               = new("0002-0001-0012-0000-0000-000000000000");
        public static readonly Guid ClevelandParkId          = new("0002-0001-0013-0000-0000-000000000000");
        public static readonly Guid WoodleyParkId            = new("0002-0001-0014-0000-0000-000000000000");
        public static readonly Guid MountPleasantId          = new("0002-0001-0015-0000-0000-000000000000");
        public static readonly Guid TrinidadId               = new("0002-0001-0016-0000-0000-000000000000");
        public static readonly Guid EckingtonId              = new("0002-0001-0017-0000-0000-000000000000");
        public static readonly Guid BloomingdaleId           = new("0002-0001-0018-0000-0000-000000000000");
        public static readonly Guid KaloramaId               = new("0002-0001-0019-0000-0000-000000000000");
        public static readonly Guid LoganCircleId            = new("0002-0001-0020-0000-0000-000000000000");
        public static readonly Guid NoMaId                   = new("0002-0001-0021-0000-0000-000000000000");
        public static readonly Guid HStreetCorridorId        = new("0002-0001-0022-0000-0000-000000000000");
        public static readonly Guid SouthwestWaterfrontId    = new("0002-0001-0023-0000-0000-000000000000");
        public static readonly Guid TheWharfId               = new("0002-0001-0024-0000-0000-000000000000");
        public static readonly Guid WestEndId                = new("0002-0001-0025-0000-0000-000000000000");
        public static readonly Guid GloverParkId             = new("0002-0001-0026-0000-0000-000000000000");
        public static readonly Guid FriendshipHeightsId      = new("0002-0001-0027-0000-0000-000000000000");
        public static readonly Guid BrightwoodId             = new("0002-0001-0028-0000-0000-000000000000");
        public static readonly Guid CongressHeightsId        = new("0002-0001-0029-0000-0000-000000000000");
        public static readonly Guid DeanwoodId               = new("0002-0001-0030-0000-0000-000000000000");
        public static readonly Guid HillcrestId              = new("0002-0001-0031-0000-0000-000000000000");
        public static readonly Guid FortTottenId             = new("0002-0001-0032-0000-0000-000000000000");
        public static readonly Guid TakomaId                 = new("0002-0001-0033-0000-0000-000000000000");
        public static readonly Guid MichiganParkId           = new("0002-0001-0034-0000-0000-000000000000");
        public static readonly Guid BellevueId               = new("0002-0001-0035-0000-0000-000000000000");
        public static readonly Guid ChevyChaseId             = new("0002-0001-0036-0000-0000-000000000000");
        public static readonly Guid NorthClevelandParkId     = new("0002-0001-0037-0000-0000-000000000000");
        public static readonly Guid AmericanUniversityParkId = new("0002-0001-0038-0000-0000-000000000000");
        public static readonly Guid ForestHillsId            = new("0002-0001-0039-0000-0000-000000000000");
    }
